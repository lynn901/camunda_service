...
jest.mock('bpmn-js/lib/Modeler', () => {
  return jest.fn().mockImplementation(() => {
    return {
      ...
      destroy: jest.fn(),
      saveXML: jest.fn().mockResolvedValue({ xml: '<bpmn/>' }),
    };
  });
});
...
jest.mock('bpmn-js/lib/NavigatedViewer', () => {
  return jest.fn().mockImplementation(() => {
    return {
      importXML: jest.fn().mockResolvedValue({}),
      destroy: jest.fn(),
      get: jest.fn().mockReturnValue({ zoom: jest.fn(), addMarker: jest.fn() }),
    };
  });
});

jest.mock('bpmn-js-properties-panel', () => ({}), { virtual: true });
jest.mock('camunda-bpmn-moddle/resources/camunda', () => ({}), { virtual: true });
