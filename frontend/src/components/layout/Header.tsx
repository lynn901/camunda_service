  ...
  return (
    <header className="h-16 bg-white border-b border-border-cream px-8 flex items-center justify-between sticky top-0 z-10">
      <div className="flex items-center gap-3">
        ...
        <span className="text-[10px] text-stone-gray uppercase tracking-widest font-sans font-medium">/ OpsConsole /</span>
        <h2 className="text-sm font-sans font-bold text-anthropic-black">Global Overview</h2>
      </div>
      ...
      <div className="flex items-center gap-6">
        <div className="relative">
          ...
          <input 
            type="text" 
            placeholder="Search Instance ID / Biz Key..." 
